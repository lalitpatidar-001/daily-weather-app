...
const DayMainDetails = ({ data, sunrise, sunset }) => {
        ...
        <div className="flex-1 flex flex-col sm:flex-row md:flex-col justify-between w-full h-full">
            ...
            <div className="flex sm:block">
                <div className="flex">
                    ...
                    <h1 className="font-bold md:text-7xl text-5xl">{data?.temp}</h1>
                    <span className="text-2xl -mt-1 font-bold">o</span>
                    <span className="font-bold text-5xl md:text-7xl">F</span>
                </div>
                ...
                <div className="sm:flex hidden items-center gap-1 ml-4 sm:ml-0">
                    ...
                    <div className="flex items-center">
                        <h1 className="font-bold text-2xl">{data?.feels_like}</h1>
            ...
            <div className="flex md:flex-col justify-center flex-row gap-2">
                ...
                <div className="flex gap-2 items-center">
                    <img src={sunrise_svg} height={45} width={40} alt="sunrise-svg" />
                ...
                <div className="flex gap-2 items-center">
                    <img src={sunset_svg} height={40} width={40} alt="sunrise-svg" />
                    <div className="flex flex-col">
